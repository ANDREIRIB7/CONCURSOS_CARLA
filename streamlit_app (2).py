...
@media (max-width: 767px) {{
  ...
  /* padding inferior para o conteúdo não ficar atrás da nav */
  ...
  /* remove o botão hamburger anterior */
  #cf-menu-btn, #cf-overlay {{ display: none !important; }}
}}
</style>
""", unsafe_allow_html=True)
